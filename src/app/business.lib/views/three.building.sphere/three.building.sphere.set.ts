...
export class ThreeBuildingSphereViewSet extends BaseViewSet {

    protected override scopeToken = "ThreeBuildingView";

    protected override ViewRenderConfiguration = ViewRenderConfiguration;
    protected override RenderController = ThreeSphereGlobeRenderController;
